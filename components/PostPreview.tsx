  ...
  return (
    <>
      <Link href={`/posts/${props.slug}`} key={props.slug}>
        <div className="hover:bg-muted hover:dark:bg-[#202023] w-[36rem] px-6 py-8 rounded-lg transition-transform transform hover:scale-105 cursor-pointer flex flex-col space-y-2">
